...
public class BloomFilter<E> implements Serializable {
    ...
    public BloomFilter() {
        this.expectedNumberOfFilterElements = 10000000;
        this.k =  (int) Math.ceil(-(Math.log(0.00001) / Math.log(2)));
        this.bitsPerElement = 0.00001;
        this.bitSetSize = (int) Math.ceil(0.00001 * 10000000);
        numberOfAddedElements = 0;
        this.bitset = new BitSet(bitSetSize);
//        this(0.00001 / (double) 10000000,  10000000, (int) Math.round((0.00001 / (double) 10000000)* Math.log(2.0)));
    }
     ...
     * @功能描述: 初始化默认过滤器
     */
    public static BloomFilter getDefaultBloomFilter() {
        BloomFilter myBloomFilter = new BloomFilter(0.00001,10000000);
